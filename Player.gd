...
func _ready():
	...
	g.add_point(0.1, Color(0.7, 0.9, 1, 1)) # Light Blue
	g.add_point(0.25, Color(0, 0.7, 1, 1)) # Cyan
	g.add_point(0.4, Color(0, 0, 1, 1))   # Blue
	g.add_point(0.8, Color(0, 0, 1, 0.33)) # 33% Opacity Blue
	p_emit.color_ramp = g
